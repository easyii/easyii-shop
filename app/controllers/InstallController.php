...
class InstallController extends \yii\web\Controller
{
    ...
    public function insertGallery()
    {
        ...
        $album1 = new gallery\models\Category([
            'title' => 'Album 1',
            'image' => '/easyii-shop/uploads/gallery/album-1.jpg',
            'order_num' => 2
        ]);
        $album1->makeRoot();
        $this->attachSeo($album1, 'Album 1 H1', 'Extended Album 1 title');
        $this->attachPhotos($album1, [
            '/easyii-shop/uploads/photos/album-1-9.jpg',
            '/easyii-shop/uploads/photos/album-1-8.jpg',
            '/easyii-shop/uploads/photos/album-1-7.jpg',
            '/easyii-shop/uploads/photos/album-1-6.jpg',
            '/easyii-shop/uploads/photos/album-1-5.jpg',
            '/easyii-shop/uploads/photos/album-1-4.jpg',
            '/easyii-shop/uploads/photos/album-1-3.jpg',
            '/easyii-shop/uploads/photos/album-1-2.jpg',
            '/easyii-shop/uploads/photos/album-1-1.jpg'
        ]);

        $album2 = new gallery\models\Category([
            'title' => 'Album 2',
            'image' => '/easyii-shop/uploads/gallery/album-2.jpg',
            'order_num' => 1
        ]);
        $album2->makeRoot();
    ...
    public function insertFiles()
    {
        ...
        (new File([
            'title' => 'Price list',
            'file' => '/easyii-shop/uploads/files/example.csv',
            'size' => 104
        ]))->save();
